	...
	<div id="chat-header" class="dark:text-gray-300">
		...
		<div class="chat-controls">
			...
			<button class="visibility open-btn">
				<svg class="icon-up" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor"
					 stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
					<polyline points="18 15 12 9 6 15"></polyline>
				</svg>
				<svg class="icon-close hidden" width="20" height="20" viewBox="0 0 24 24" fill="none"
